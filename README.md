...
| Latest contribution review | `integration/g1-acceptance-20260917` at `da1c0fcd` | All eight branch/merge stages passed; 320 final tests, no skips and one separate GPU test. New X/headset review remains pending. |
