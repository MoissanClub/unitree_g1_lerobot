...
The upstream-oriented fork has standalone bug-fix and keyboard-arm-control branches followed by embodiment,
...
[dated revision note](branch-stack-update-keyboard-20260918.md) for what changed.
