...
For the new fork-based VR simulator, see [installation and host prerequisites](../../coworker-installation.md):
...
For branch-by-branch development with manual test commands, use the
[branch-aware development workspace](../../development-workspace.md):
`source ~/lerobot-dev/lerobot-dev.sh`, then `lerobot-switch dev/g1-integration`.
...
**Roadmap:** [three-track project plan](project-plan.md).
**Resume contribution review:** [branch-stack handoff](branch-stack-handoff.md).
**Experimental history:** [Rung 4 handoff](rung4-handoff.md).
**Future experiments:** [non-physical acceptance and reliability work](future-non-physical-work.md).
...
live under `archive/integration/*`; see the [reference migration](../../branch-reference-migration-20260918.md).
Use the [branch plan](lerobot_g1_branching_refactor_plan.md) for dependencies
and the [verification guide](../../branch-stack-verification.md) for results and commands.
...
See [per-stage acceptance commands](../../branch-stack-commands.md) for manual review.
...
Historical plans and checkpoints are linked from the [documentation archive](../README.md).
...
on both embodiments; see [coverage and reports](../../live-control-acceptance.md).
Add `--geometry` for [independent MuJoCo checks](../../independent-geometry.md).
The [source audit](../../g1-model-source-audit.md) corrects the initial torso-frame
interpretation and identifies G1-29 model-family differences relevant to waist motion.
**Design:** [architecture and upstream boundaries](architecture.md).
**Physical Stage 0:** [read-only preflight, lifecycle audit, and offline verification](../../physical-preflight.md).
The [rung ladder](vr-teleop-g1-23-ladder.md) preserves earlier acceptance milestones;
...
See [configuration and backend boundaries](architecture.md#configurable-g1-runtime-structure).
...
See the [operator guide](../../operator-guide.md) for one-time setup, headset connection,
...
[camera commands, frame contract, and verification](../../camera-streaming.md).
...
legs, and waist are supported. See [live simulator details](../../g1-23-live-simulator.md).
...
summary](../../motor-config-comparison.md) for controls, metrics, payloads, and limits.
...
See [verification organization](../../verification-organization.md) for module locations,
test discovery, simulation/physical reuse boundaries, and opt-in integration checks.

## Verification and Next Work

The [diagnostic/test organization migration](../../verification-organization.md#migration-verification-2026-09-10)
...
See [Finding 10: evidence and next investigation](vr-teleop-g1-23-ladder.md#finding-10-dds-session-teardown).
...
[acceptance sequence](project-plan.md#cross-track-acceptance).
